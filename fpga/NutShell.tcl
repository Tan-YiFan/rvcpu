...
proc create_root_design { parentCell } {
  ...
  # Create instance: SimTop_0, and set properties
  set block_name SimTop
  set block_cell_name SimTop_0
  if { [catch {set SimTop_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net SimTop_0_io_mem [get_bd_intf_pins SimTop_0/io_mem] [get_bd_intf_pins axi_interconnect_2/S00_AXI]
  connect_bd_intf_net -intf_net SimTop_0_io_mmio [get_bd_intf_pins SimTop_0/io_mmio] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins SimTop_0/io_frontend] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_net -net SimTop_0_io_ila_InstrCnt [get_bd_pins SimTop_0/io_ila_InstrCnt] [get_bd_pins system_ila_0/probe5]
  connect_bd_net -net SimTop_0_io_ila_WBUpc [get_bd_pins SimTop_0/io_ila_WBUpc] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net SimTop_0_io_ila_WBUrfData [get_bd_pins SimTop_0/io_ila_WBUrfData] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net SimTop_0_io_ila_WBUrfDest [get_bd_pins SimTop_0/io_ila_WBUrfDest] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net SimTop_0_io_ila_WBUrfWen [get_bd_pins SimTop_0/io_ila_WBUrfWen] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net SimTop_0_io_ila_WBUvalid [get_bd_pins SimTop_0/io_ila_WBUvalid] [get_bd_pins system_ila_0/probe1]
  ...
  connect_bd_net -net coreclk_1 [get_bd_ports coreclk] [get_bd_pins SimTop_0/clock] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net intrs_1 [get_bd_ports intrs] [get_bd_pins SimTop_0/io_meip]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins SimTop_0/reset] [get_bd_pins util_vector_logic_0/Res]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x80000000 [get_bd_addr_spaces SimTop_0/io_mem] [get_bd_addr_segs AXI_MEM/Reg] SEG_AXI_MEM_Reg
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces SimTop_0/io_mmio] [get_bd_addr_segs AXI_MMIO/Reg] SEG_AXI_MMIO_Reg
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AXI_DMA] [get_bd_addr_segs SimTop_0/io_frontend/reg0] SEG_SimTop_0_reg0
